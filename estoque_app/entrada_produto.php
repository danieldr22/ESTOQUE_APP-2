...
// Verificação da conexão (para depuração, pode ser removido em produção)
if (!$link) {
...
<body class="h-full">
    ...
    <div class="container">
        ...
        <h1 class="text-3xl font-bold text-center mb-8">Registrar Entrada de Produto</h1> <form action="processa_entrada.php" method="POST" class="grid grid-cols-1 gap-4 mb-8 p-6 bg-white rounded-lg shadow-md">
            <div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    if ($result_entradas && mysqli_num_rows($result_entradas) > 0) {
                        ...
                        mysqli_free_result($result_entradas);
                    } else {
